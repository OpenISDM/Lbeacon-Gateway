...
typedef enum ErrorCode{
    ...
    WORK_SUCCESSFULLY = 0,
    E_CONFIG_LOAD_FAIL = 1,
    E_MALLOC = 2,
    E_INITIALIZATION_FAIL = 3,
    E_WIFI_INIT_FAIL = 4,
    E_ZIGBEE_INIT_FAIL = 5,
    E_XBEE_VALIDATE = 6,
    E_START_COMMUNICAT_ROUTINE_THREAD = 7,
    E_START_BHM_ROUTINE_THREAD = 8,
    E_START_TRACKING_THREAD = 9,
    E_START_THREAD = 10
